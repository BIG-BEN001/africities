...
<head>
    ...
    <link href="africities/css/style.css" rel="stylesheet">
...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-dark topbar mb-4 static-top shadow">
                    <div class="container">
                        <div class="float-left" >
                            <img id="logo1" src="africities/img/logo.png" alt="">
                        </div>

                        <div id="logo3">
                            <img id="logo1" src="africities/img/CGK_Website_Logo.png" alt="">
                        </div>

                        <div class="float-right" >
                            <img id="logo2" src="africities/img/afri1.png" alt="">
                        </div>
    ...
    <script src="africities/js/main.js"></script>
</body>
